...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(
            code=core.migrations.0003_load_countries.Migration.forwards_func,
            reverse_code=core.migrations.0003_load_countries.Migration.reverse_func,
        ),
        ...
        migrations.RunPython(
            code=core.migrations.0005_auto_20170816_0851.Migration.forwards_func,
            reverse_code=core.migrations.0005_auto_20170816_0851.Migration.reverse_func,
        ),
        migrations.AlterModelOptions(
            name='newsitem',
            options={},
        ...
        migrations.RunPython(
            code=core.migrations.0009_auto_20170925_1133.fix_uuids,
        ),
        migrations.AddField(
            model_name='account',
        ...
        migrations.RunPython(
            code=core.migrations.0019_adds_DomainAlias_journal_FK.sitesectomy,
        ...
        migrations.RunPython(
            code=core.migrations.0019_set_default_news_items.set_default_news_items,
            reverse_code=django.db.migrations.operations.special.RunPython.noop,
        ),
        migrations.RunPython(
            code=core.migrations.0023_fix_journal_base_url_from_settings.replace_journal_base_url,
            reverse_code=django.db.migrations.operations.special.RunPython.noop,
        ),
        migrations.RunPython(
            code=core.migrations.0024_auto_20190201_1015.fix_featured_articles,
            reverse_code=django.db.migrations.operations.special.RunPython.noop,
        ),
        migrations.AlterField(
            model_name='account',
        ...
        migrations.RunPython(
            code=core.migrations.0025_fix_bad_journal_urls_in_template.replace_bad_urls,
            reverse_code=django.db.migrations.operations.special.RunPython.noop,
        ),
        migrations.AddField(
            model_name='account',
        ...
        migrations.RunPython(
            code=core.migrations.0028_fix_bad_email_urls.replace_bad_urls,
            reverse_code=django.db.migrations.operations.special.RunPython.noop,
        ),
        migrations.RunPython(
            code=core.migrations.0029_rename_setting.replace_setting_name,
            reverse_code=core.migrations.0029_rename_setting.undo_replace_setting_name,
        ),
        migrations.AlterModelOptions(
            name='settingvalue',
            options={},
